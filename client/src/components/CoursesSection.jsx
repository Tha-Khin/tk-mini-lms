...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 px-8 md:px-40 bg-linear-to-b from-cyan-100/70 w-full'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3 px-5 md:px-50'>Discover our top-rated courses across various categories. From sales and marketing to business and personal development, our courses are crafted to deliver results.</p>
